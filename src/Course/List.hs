...
seqOptional ((Full x) :. y) = let r = seqOptional y
                               in case r of Empty -> Empty
                                            Full u -> let z = Full (x :. u)
                                                      in z
...
lengthGT4 a = chklen a 0
              where chklen Nil l = l > 4
                    chklen (_ :. y) l = if l > 4
                                           then True
                                           else chklen y (l + 1)
